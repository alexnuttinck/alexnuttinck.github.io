...
menu:
  sidebar:
    name: 15 - Working from Shed
    identifier: 15-working-from-shed.png
    parent: adventures-in-uptime
    weight: 16
---

{{< img src="/posts/adventures-in-uptime/15-working-from-shed.png" title="Adventures in Uptime - Working from Shed" >}}
